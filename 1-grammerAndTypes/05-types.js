...
//undefined
/*
Undefined usually means a variable has been declared, but it's not been assigned a variable
*/
...
Denoted by {}
Have keys and values--color (key): 'blue' (value), seperated with a colon, each key-value part is seperated with a comma.
*/
...
console.log('Hulk Age + Color:',hulk.age,hulk.color)
console.log('Hulk Strong:'+ hulk.isStrong)

//Arrays
/*
Arrays stores multiple values in an ordered way. They, too, hold multiplehold mulitple data types.

Denoted by []
Have values ('blue', 'green', 'yellow'), seperated by commas
*/
...
console.log(stepsToBrushTeeth[3]); //brush
